...
<head>
    ...
    <title>Verifikasi OTP - Desa Banjardowo</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== OTP HINT - Teks di bawah input ===== */
        .otp-hint {
            text-align: center;
            color: #6b7280;
            font-size: 13px;
            margin-top: 12px; /* Jarak dari input */
            display: flex;
            align-items: center;
            justify-content: center;
            gap: 6px;
...
<body class="login-body">
    ...
    <div class="login-wrapper">
        ...
        <div class="login-form-section">
            <h2>Kode OTP</h2>
            <p class="subtitle">Masukkan 6 digit kode verifikasi</p>
            ...
            @if (session('debug_otp'))
                <div class="alert-success">
                    ...
                    <strong>OTP Debug:</strong> {{ session('debug_otp') }}
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('password.otp.verify') }}" novalidate>
                ...
                <div class="form-group">
                    ...
                    <p class="otp-hint">
                        <i class="fas fa-info-circle"></i> Masukkan 6 angka tanpa spasi
                    </p>
                </div>
