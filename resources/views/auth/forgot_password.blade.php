...
<head>
    ...
    <title>Lupa Password - Desa Banjardowo</title>
...
<body class="login-body">
    ...
    <div class="login-wrapper">
        ...
        <div class="login-form-section">
            ...
            <p class="subtitle">Kirim kode OTP ke email Anda</p>
            ...
            @if(session('debug_otp'))
                <div class="alert-success">
                    <i class="fas fa-key"></i> OTP Debug: {{ session('debug_otp') }}
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('password.email') }}" novalidate>
                ...
                {{-- LANJUT OTP (Muncul jika status ada) --}}
                @if(session('status'))
                    <div class="forgot-password">
                        <a href="{{ route('password.verify') }}" style="color: #28a745; font-weight: 600;">
                            Lanjut Verifikasi OTP <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                @endif
