...
.login-box {
    ...
    margin-top: 40px; /* 🔥 biar agak turun dikit */
}
...
.btn-login {
    ...
    background: #79A6F2; /* warna utama */
    color: #ffffff; /* teks hitam */

    border: none;
    border-radius: 10px; /* 🔥 biar rounded besar kayak figma */
    ...
    /* 🔥 double shadow (hitam + biru) */
    box-shadow: 
        0 1px 0 #000000,      /* shadow hitam bawah */
        0 5px 5px #79A6F2;  /* glow biru */
