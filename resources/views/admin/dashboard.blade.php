...
@section('content')
    ...
    <script>
        ...
        // ✅ AMBIL DATA DINAMIS DARI CONTROLLER (Blade Directive)
        ...
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: chartLabels, // ✅ Pakai variabel dinamis
                datasets: [{
                    label: 'Jumlah Saran',
                    data: chartData, // ✅ Pakai variabel dinamis
                    borderColor: '#2f80ed',
            ...
            options: {
                ...
                scales: {
                    y: {
                        beginAtZero: true,
                        ticks: { stepSize: 1 } // Biar angka bulat
                    }
                }
            }
        });
