...
<style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .sidebar-header{position:fixed;top:20px;left:20px;background:transparent;padding:10px;display:flex;align-items:center;gap:12px}
    ...
    .top-bar{display:flex;align-items:center;justify-content:flex-end;margin-bottom:14px}
    ...
    .btn-primary{background:linear-gradient(200deg,#1c3f9f,#3B82F6);color:#fff;border-radius:8px;padding:10px 20px;font-size:13px;border:none;cursor:pointer;font-weight:500}
    ...
    .upload-box{width:100%;min-height:200px;border:2px dashed #d1d5db;border-radius:16px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#6b7280;font-size:14px;position:relative;overflow:hidden;background:#fff}
