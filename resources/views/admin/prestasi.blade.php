...
@section('content')
<style>
    /* Paste semua CSS yang sama dengan kegiatan.blade.php */
    ...
    <div class="main">
        ...
        @if($action === 'tambah' || $action === 'edit')
            <div class="content-card content-card-form">
                <div class="header-row">
                    <div>
                        <h2 class="page-title">{{ $page_title ?? ($action === 'tambah' ? 'Tambah Prestasi' : 'Edit Prestasi') }}</h2>
...
<div id="deleteModal" class="modal-backdrop">
    <div class="modal-card">
        ...
        <div class="modal-title">Hapus data prestasi?</div>
